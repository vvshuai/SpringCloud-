...
import org.vvs.coupon.converter.CouponCategoryConverter;
import org.vvs.coupon.converter.DistributeTargetConverter;
import org.vvs.coupon.converter.ProductLineConverter;
import org.vvs.coupon.converter.RuleConverter;
 ...
 * @Date: Created in 22:07 2020/10/15
 * @Modified By:
 */
@Data
@NoArgsConstructor
...
public class CouponTemplate implements Serializable {
    ...
    public CouponTemplate(String name, String logo, String desc, String category,
        ...
        this.count = count;
        this.userId = userId;
        // 优惠唯一编码 = 4(产品线和类型) + 8(日期：20200101） + id(扩充成四位)
